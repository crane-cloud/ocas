...
pub struct Distance<'a> {
    ...
    reference_front: Vec<OIndividual>,
}
...
impl<'a> Distance<'a> {
    ...
    pub fn generational_distance(&self) -> Result<f64, OOError> {
    ...
    ///
    /// returns: `Result<f64, OError>`
    pub fn inverted_generational_distance(&self) -> Result<f64, OOError> {
        Self::_generational_distance(
            &self.reference_front,
            self.individuals,
            Distance::euclidian_distance,
    ...
    ///
    /// returns: `Result<f64, OError>`
    pub fn generational_distance_plus(&self) -> Result<f64, OOError> {
        Self::_generational_distance(
            self.individuals,
            &self.reference_front,
    ...
    ///
    /// returns: `Result<f64, OError>`
    pub fn inverted_generational_distance_plus(&self) -> Result<f64, OOError> {
        Self::_generational_distance(
            &self.reference_front,
            self.individuals,
            Distance::distance_plus,
    ...
    ///
    /// returns: `Result<f64, OError>`
    pub fn hausdorff_distance(&self) -> Result<f64, OOError> {
        Ok(f64::max(
    ...
    ///
    /// returns: `Result<f64, OError>`
    fn distance_plus(a: &OIndividual, r: &OIndividual, is_inverse: bool) -> Result<f64, OOError> {
    ...
    where
        F: Fn(&OIndividual, &OIndividual, bool) -> Result<f64, OOError>,
    {
        let p = p.unwrap_or(1);
