...
///    de-serialisable.
///  - add the following fields: stopping_condition (`OStoppingConditionType`), parallel (`bool`)
///    and export_history (`Option<OExportHistory>`).
#[proc_macro_attribute]
        ...
        syn::Data::Struct(ref mut struct_data) => {
            if let syn::Fields::Named(fields) = &mut struct_data.fields {
                fields.named.push(
                    syn::Field::parse_named
                        .parse2(quote! {
                            ...
                            pub stopping_condition: OStoppingConditionType
                        })
                ...
                fields.named.push(
                    syn::Field::parse_named
                        .parse2(quote! {
                            /// Whether the objective and constraint evaluation in [`OProblem::evaluator`] should run
                ...
                fields.named.push(
                    syn::Field::parse_named
                        .parse2(quote! {
                            ...
                            pub export_history: Option<OExportHistory>
                        })
            ...
            let expand = quote! {
                use crate::algorithms::{OStoppingConditionType, OExportHistory};
    ...
    match &mut ast.data {
        syn::Data::Struct(ref mut struct_data) => {
                ...
                fields.named.push(
                    syn::Field::parse_named
                        .parse2(quote! {
                            ...
                            stopping_condition: OStoppingConditionType
                        })
                        .expect("Cannot add `stopping_condition` field"),
                );
                fields.named.push(
                ...
                fields.named.push(
                    syn::Field::parse_named
                        .parse2(quote! {
                            ...
                            export_history: Option<OExportHistory>
                        })
                        .expect("Cannot add `export_history` field"),
                );
                fields.named.push(
            ...
            let expand = quote! {
                ...
                use std::sync::Arc;
                use crate::core::{OProblem, OPopulation};
